...
%    \begin{flushleft}
    ...
    \datum{24.05.2024}
%    \end{flushleft}
    \dedication{Diese Diplomarbeit widme ich meiner Familie, Gabriele Santangelo, Niculin Fürst, der mir \LaTeX nähergebracht hat, meinem Arbeitgeber und Andrea Meili.}
    \maketitle
    \clearpage
