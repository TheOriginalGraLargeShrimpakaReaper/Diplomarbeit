...
\begin{flushleft}
    ...
    \begin{figure}[H]
        \centering
        \subfloat{{\includegraphics[width=0.47\linewidth]{source/riskmatrix/riskmatrix-project} }}%
        \qquad
        \subfloat{{\includegraphics[width=0.47\linewidth]{source/riskmatrix/Riskmatrix-project-massnahmen} }}%
