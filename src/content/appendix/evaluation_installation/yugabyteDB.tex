...
Für das Benchmarking wird die Tabelle pgbench\_eval\_bench erstellt.
Zudem wird je ein Tablespace für die Indizes (eval\_index\_tablespace) und Daten (eval\_data\_tablespace) erstellt.\\
...
Dies wird folgndermassen via SQL ausgelesen:
\lstset{style=gra_codestyle}
...
Mit diesen Informationen lassen sich nun die
\lstset{style=gra_codestyle}
