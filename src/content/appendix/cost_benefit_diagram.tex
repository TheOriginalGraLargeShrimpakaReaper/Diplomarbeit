...
% Preamble
\section{cost_benefit_diagram.py}
\begin{lstlisting}[language=python, caption=Python LaTex - cost_benefit_diagram - Kosten-Nutzen-Diagramm,captionpos=b,label={lst:cost_benefit_diagram},breaklines=true]
