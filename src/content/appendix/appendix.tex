...
%    \input{content/appendix/pgpoolII}
    ...
    \input{content/appendix/sks9016_yugabyte}
    \input{content/appendix/patroni}
    \input{content/appendix/zotero}
    \input{content/appendix/zotero_bibtex_configuration}
    \input{content/appendix/zotero_biblatex_keystore}
    \input{content/appendix/riskmatrix}
    \input{content/appendix/riskmatrix_plotter_conf}
    \input{content/appendix/riskmatrix_xy_axis_tuple_matrix}
    \input{content/appendix/cost_benefit_diagram}
    \input{content/appendix/cost_benefit_diagram_plotter_conf}
    \input{content/appendix/pandas_dataframe_to_latex_table}
    \input{content/appendix/csv_to_latex_diplomarbeit}
    \input{content/appendix/pandas_data_chart_plotter}
    \input{content/appendix/pandas_data_chart_plotter_conf}
