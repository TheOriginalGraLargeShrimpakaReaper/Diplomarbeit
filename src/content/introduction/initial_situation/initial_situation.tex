...
%    \begin{figure}[H]
%        \centering
%        \includegraphics[width=0.75\linewidth]{source/pandas_data_chart_plotter/db_inventory_per_rdbms_database}
%        \caption{Datenbanken - Aufgeschlüsselt nach RDBMS - Datenbanken}
%        \label{fig:db_inventory_per_rdbms_database}
%    \end{figure}
%    \begin{figure}[H]
%        \centering
%        \includegraphics[width=0.75\linewidth]{source/pandas_data_chart_plotter/db_inventory_per_rdbms_instance}
